...
class Southeastern: UIViewController,UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        pageImages = [
            ...
            UIImage(named:"image-01.jpg")!,
            UIImage(named:"image-02.jpg")!,
            UIImage(named:"image-03.jpg")!,
            UIImage(named:"image-10.jpg")!,
            UIImage(named:"image-11.jpg")!,
            UIImage(named:"image-12.jpg")!,
            UIImage(named:"image-13.jpg")!,
            UIImage(named:"image-14.jpg")!,
            UIImage(named:"image-15.jpg")!,
            UIImage(named:"image-17.jpg")!,
            UIImage(named:"image-16.jpg")!
